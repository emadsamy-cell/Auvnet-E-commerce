...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>This OTP is valid for ${otp.expiresAt}.</p>
        </div>
        <div class="footer">
...
<body>
    <div class="container">
        ...
        <p>This OTP is valid for the next ${otp.expiresAt}. If you did not request a password reset, please ignore this email.</p>
