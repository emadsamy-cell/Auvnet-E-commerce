...
const { GET_USER, UPDATE_USER } = require("../../endpoints/user.endpoints");

// Category Endpoints Policy
const { GET_CATEGORY } = require("../../endpoints/category.endpoints");
...
const { GET_ADS } = require("../../endpoints/ad.endpoints");
